...
8 channels, lowpass filter @ 40Hz, BOTH recording sessions (Oct 31 + Nov 21)
Commands: Rest (0), Cmd2, Cmd3, Cmd4, Cmd5
Only using common stimuli that appear in both sessions
"""
...
def create_dataset(bin_folder='data-raw/', output_file='game_controller_dataset_both.npz'):
    """Create dataset from BOTH Oct 31 and Nov 21 files, only common stimuli."""

    # Files from both recording sessions
    files_20251031 = [
        'Data_20251031_101158_Georg.bin',
        'Data_20251031_103417_Muratcan.bin',
        'Data_20251031_105214_Samuel.bin',
        'Data_20251031_111742_Cornel.bin',
        'Data_20251031_113055_Bhavya.bin',
        'Data_20251031_113938_Rares.bin'
    ]
    ...
    all_files = files_20251031 + files_20251121

    # Only use triggers that appear in both sessions
    allowed_triggers = [0, 2, 3, 4, 5]
    ...
    print("="*70)
    print("Files: Oct 31 (6 files) + Nov 21 (3 files) = 9 total")
    print("Allowed triggers: 0, 2, 3, 4, 5 (common stimuli only)")
    print("Other triggers (1, 12, 81) will be skipped")
    print("="*70)
    ...
    for filename in all_files:
        ...
        try:
            ...
            for trigger_val, trigger_segments in segments.items():
                ...
                # Only use allowed triggers
                if trigger_val not in allowed_triggers:
                    print(f"  Skipping trigger {trigger_val} (not in allowed list)")
                    continue
...
def main():
    ...
    print("\n" + "="*70)
    print("BCI GAME CONTROLLER - TRAINING PIPELINE (BOTH SESSIONS)")
    print("="*70)
    print("Configuration:")
    print("  - 8 EEG channels")
    print("  - Lowpass filter @ 40 Hz")
    print("  - Oct 31 + Nov 21 data")
    print("  - Common stimuli only: 0, 2, 3, 4, 5")
    print("="*70)

    # Step 1: Create dataset
    X, y = create_dataset(bin_folder='data-raw/',
                         output_file='game_controller_dataset_both.npz')
    ...
    # Step 4: Save model
    model_path = 'game_controller_model_both.pth'
    torch.save({
